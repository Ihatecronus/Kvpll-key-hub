...
-- KEY SYSTEM: Luarmor-style (works on ALL executors - no HTTP required)
-- Keys are hashed and verified locally

local Player = game:GetService("Players").LocalPlayer
local PlayerGui = Player:WaitForChild("PlayerGui")

-- ============================================================================
-- SIMPLE MD5 HASH (for key verification)
-- ============================================================================
local function MD5(str)
    local md5 = loadstring(game:HttpGet("https://raw.githubusercontent.com/Equim-chan/Lua/master/src/md5.lua"))() or {}
    if md5.sumhexa then
        return md5.sumhexa(str)
    end
    -- Fallback: use simple hash if MD5 library fails
    local hash = 0
    for i = 1, #str do
...
-- ============================================================================
-- VALID KEY HASHES (Auto-generated by update-keys.js on your machine)
-- Replace these when you use !genkey in Discord
-- ============================================================================
local KEY_HASHES = {
    ["5367b55b"] = true,  -- 5367B55B
    ["cb3e57ec"] = true,  -- CB3E57EC
    ["ef28614c"] = true,  -- EF28614C
}
...
local function VerifyKey(inputKey)
    ...
    local normalizedKey = string.lower(inputKey)
    
    -- Check if key hash exists in valid keys
    if KEY_HASHES[normalizedKey] then
        statusLabel.Text = "✅ Valid Key!\n\nLoading Evade Hub..."
        statusLabel.TextColor3 = Color3.fromRGB(100, 255, 100)
        return true
    else
        statusLabel.Text = "❌ Invalid Key\n\nTry again or get a key from Discord"
        statusLabel.TextColor3 = Color3.fromRGB(255, 100, 100)
        return false
    end
end
